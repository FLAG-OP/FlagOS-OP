...
|---|---|---|---|---|---|
| [sdpa](sdpa/)（scaled_dot_product_attention） | Triton / 厂商委托 | A1（aten 拦截） | ✅ 定稿 | [REPORT](sdpa/REPORT.md) | ascend910 + p800-kunlunxin · 双平台黄金 265/265 · [平台绑定](sdpa/PLATFORM.md) / [多平台合并](sdpa/MERGE.md) |

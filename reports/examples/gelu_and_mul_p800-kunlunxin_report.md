...
| 层级 | 状态 | 耗时 | 关键结论 `[手填]` |
|---|---|---|---|
| kernel 直测 | ✅ PASS | 7.9s | <手填> |
| op 注册/分发 | ✅ PASS | 7.9s | <手填> |
| framework 真实推理 | ✅ PASS | 108.0s | <手填> |
...
```bash
python3 run.py --route a2 --level kernel --device p800-kunlunxin
